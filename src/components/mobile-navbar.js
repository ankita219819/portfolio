...
const MobileNavbar = () => {
    ...
    return (
        <div class="nav">
            <a href="#projects" class="m-nav" onClick={() => setActiveNav('#')} className={activeNav === '#' ? 'active' : ''}>
            ...
            <a href="#about" class="m-nav" onClick={() => setActiveNav('#about')} className={activeNav === '#about' ? 'active' : ''}>
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2a5 5 0 1 0 5 5 5 5 0 0 0-5-5zm0 8a3 3 0 1 1 3-3 3 3 0 0 1-3 3zm9 11v-1a7 7 0 0 0-7-7h-4a7 7 0 0 0-7 7v1h2v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1z"></path>
                </svg>
            </a>
            <a href="#experience" class="m-nav" onClick={() => setActiveNav('#experience')} className={activeNav === '#experience' ? 'active' : ''}>
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#portfolio" class="m-nav" onClick={() => setActiveNav('#portfolio')} className={activeNav === '#portfolio' ? 'active' : ''}>
            ...
            <a href="#contact" class="m-nav " onClick={() => setActiveNav('#contact')} className={activeNav === '#contact' ? 'active' : ''}>
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
